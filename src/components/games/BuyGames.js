        ...
        <Col md={4} className="d-flex justify-content-center mb-2">
          <Card style={{ width: "18rem" }} border="primary">
            ...
            <Card.Body>
              ...
              <Card.Text>&#8358;{plans.basic.price}</Card.Text>
              <Card.Text>{plans.basic.odds} Odds Minimum</Card.Text>
              ...
              <LinkContainer to="/subscription/info/#basic">
                <Button variant="outline-info" block size="sm">
                  <FcInfo /> Info
                </Button>
              </LinkContainer>
            </Card.Body>
        ...
        <Col md={4} className="d-flex justify-content-center mb-2">
          <Card style={{ width: "18rem" }} border="primary">
            ...
            <Card.Body>
              ...
              <Card.Text>&#8358;{plans.standard.price}</Card.Text>
              <Card.Text>{plans.standard.odds} Odds Minimum</Card.Text>
        ...
        <Col md={4} className="d-flex justify-content-center mb-2">
          <Card style={{ width: "18rem" }} border="primary">
            ...
            <Card.Body>
              ...
              <Card.Text>&#8358;{plans.gold.price}</Card.Text>
              <Card.Text>{plans.gold.odds} Odds Minimum</Card.Text>
